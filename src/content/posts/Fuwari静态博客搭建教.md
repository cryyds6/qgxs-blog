...
description: 一份从零开始，涵盖本地配置到部署上线的完整Fuwari静态博客搭建指南。
tags: ["教程", "博客", "Fuwari", "技术"]
category: qgxs
draft: false
---
...
1.  **Fork仓库**：访问 [Fuwari 官方仓库](https://github.com/saicaca/fuwari)，点击右上角「Fork」，将仓库复制到自己的GitHub账号下。
2.  **克隆仓库到本地**：
